...
class H5Dataset(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        x_data = torch.Tensor(group['X'][:7], device = CPUdevice)
...
class DeconvNet(nn.Module):
    def __init__(self):
        ...
        self.deconv = nn.Sequential(
           ...
           nn.BatchNorm2d(32),
           nn.ReLU(),
           nn.ConvTranspose2d(32, 1, kernel_size=kernel_size1, stride=stride1, padding=padding1),   
           nn.BatchNorm2d(1),
           nn.ReLU()
        )
...
def train():
    file_path = r'log_normed_data_2mio.h5'
