...
def train():
    file_path = r'../Aufgabe2/normed_data.h5'
    batch_size = 32
    lr = 0.001
    n_epochs = 1000
    ...
    for epoch in range(n_epochs):
        ...
        if epoch % 50 == 0 or epoch == 1:
            ...
            with torch.no_grad():
                ...
                sample_outputs = scaler.inverse_transform(sample_outputs[0].detach().numpy().flatten().reshape(-1, 1)).reshape(256, 256)
